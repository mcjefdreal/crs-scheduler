...
>
	...
	>
		...
		<div class="overflow-y-auto p-6">
			{#if removed.length > 0}
				<section class="mb-6">
					<h3 class="mb-3 text-sm font-semibold uppercase tracking-wide text-red-700">Removed Sections</h3>
					<ul class="space-y-2">
						{#each removed as item}
							<li class="flex items-center gap-3 rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-sm">
			...
			{#if added.length > 0}
				<section class="mb-6">
					<h3 class="mb-3 text-sm font-semibold uppercase tracking-wide text-emerald-700">Added Sections</h3>
					<ul class="space-y-2">
						{#each added as item}
							<li class="flex items-center gap-3 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm">
			...
			{#if changed.length > 0}
				<section class="mb-6">
					<h3 class="mb-3 text-sm font-semibold uppercase tracking-wide text-amber-700">Changed Sections</h3>
					<ul class="space-y-2">
